...
public class MainActivityOld extends Activity
{
	...
	private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
		public void onReceive(Context context, Intent intent) {
			...
			else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action))
			{
				...
				Intent newIntent = new Intent(MainActivityOld.this, DeviceListActivity.class);
	...
	private View.OnClickListener btnEmparejarListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			else
			{
				...
				Intent intent = new Intent(MainActivityOld.this, DeviceListActivity.class);
	...
	private  boolean checkPermissions() {
		...
		if (!listPermissionsNeeded.isEmpty()) {
			String[] arrayPermissions = listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]);
			ActivityCompat.requestPermissions(this, arrayPermissions, MULTIPLE_PERMISSIONS );
			return false;
		}
		return true;
	}
